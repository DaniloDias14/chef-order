...
export default function LoginPage() {
  ...
  const handleLogin = async (formData: FormData) => {
    ...
    try {
      ...
      const tokenMock = "jwt-87324hKJSAHD@12-SADJK@#@23cjksah";
        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 md:p-10 rounded-[40px] shadow-2xl">
          <header className="mb-8">
            ...
            <p className="text-zinc-500 text-sm font-medium">
              Acesse sua cozinha digital para gerenciar pedidos.
            </p>
          </header>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link
                  ...
                  className="text-[10px] font-bold text-orange-500 hover:text-orange-400 uppercase tracking-wider"
                >
                  Esqueceu?
                </Link>
              </div>
