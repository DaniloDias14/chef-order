...
export default function Usuarios() {
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            {/* Header: TÃ­tulo e BotÃ£o de Novo UsuÃ¡rio */}
            ...
            {/* Container da Tabela com Scroll Horizontal se necessÃ¡rio */}
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-200">
                                <th className="px-6 py-4 text-sm font-semibold text-slate-600">CÃ³digo</th>
                                ...
                                <th className="px-6 py-4 text-sm font-semibold text-slate-600 text-right">AÃ§Ãµes</th>
                            </tr>
                        </thead>
